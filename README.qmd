...
This session introduces the foundation necessary to follow along with the software. It covers the basics of time series decomposition and forecasting using fable for R.

- **Tidy time series data and forecasting (background)**  
...
The second session showcases more advanced forecast combination techniques. It starts with ensemble forecasting, then finishes with forecast reconciliation for hierarchical and grouped time series.
